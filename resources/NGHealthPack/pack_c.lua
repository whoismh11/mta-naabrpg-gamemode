...
function openBuyWindow ( )
	...
	gui.Label = guiCreateLabel(128, 28, 215, 85, "Shoma mitavanid har health pack ra be gheymate $500 kharidari konid, Va aan ra hengame kam shodane joone khod estefade konid. 10% az joone shoma ra bazsazi mikonad.", false, gui.window)
	guiLabelSetHorizontalAlign ( gui.Label, "left", true )
	gui.Buy = guiCreateButton(249, 134, 94, 36, "Kharide Health Pack", false, gui.window)
	gui.Close = guiCreateButton(149, 134, 94, 36, "Bastan", false, gui.window)
	showCursor ( true )
