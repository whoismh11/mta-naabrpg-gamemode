...
addEventHandler ( "NGHealthPacks->Modules->Packs->onPlayerBuypack", root, function ( )
	...
	if ( source.money < 500 ) then
		return exports.ngmessages:sendClientMessage ( "Baraye kharide health pack bayad hade aghal $500 dashte bashid.", source, 255, 0, 0 )
	end
	...
	exports.ngmessages:sendClientMessage ( "Shoma yek health pack be mablaghe $500 kharidari kardid.", source, 0, 255, 0 )
