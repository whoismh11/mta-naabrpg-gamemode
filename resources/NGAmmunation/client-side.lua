...
function dxDrawInterface( )
	...
	dxDrawBorderedText ("Rahnama", sx - ( rSX * 300 ), sy / 2 - ( rSY * 150 ) /2 - ( rSY * 20 ), sx - ( rSX * 20 ), sy / 2 - ( rSY * 150 ) /2 + ( rSY * 20 ), tocolor(255, 255, 255, 255), rSY*2.30, "beckett", "center", "center", false, false, false, false, false)
	dxDrawText ( "Az felesh haye bala va payin baraye harekat estefade konid", sx - rSX*290,  sy / 2 - rSY*150 /2 + rSY*35, 0, 0, tocolor(255, 255, 255, 255), rSY*0.85, "default-bold", "left", "top", false, false, false, false, false)
	dxDrawText ( "Az Space baraye entekhab kardan estefade konid", sx - rSX*290,  sy / 2 - rSY*150 /2 + rSY*55, 0, 0, tocolor(255, 255, 255, 255), rSY*0.85, "default-bold", "left", "top", false, false, false, false, false)
	dxDrawText ( "Az Backspace baraye bazgasht ya kharej shodan estefade konid", sx - rSX*290,  sy / 2 - rSY*150 /2 + rSY*75, 0, 0, tocolor(255, 255, 255, 255), rSY*0.85, "default-bold", "left", "top", false, false, false, false, false)
	...
	dxDrawBorderedText ("Mohemaat", menuX, ( sy / 2 - rSY*374 / 2 )-rSY*15, menuX+rSX*325, rSY*324, tocolor(255, 255, 255, 255), rSY*2, "beckett", "center", "top", false, false, false, false, false)
	if ( menu == "main" ) then
