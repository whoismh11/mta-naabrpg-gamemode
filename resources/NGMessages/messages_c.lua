...
addEventHandler ( "onClientPlayerJoin", root, function ( ) 
	if joinquit then
		sendClientMessage ( "* "..getPlayerName(source).." varede server shod", 255, 150, 150 )
	end
end ) addEventHandler ( "onClientPlayerQuit", root, function ( r )
	if ( joinquit ) then
		sendClientMessage ( "* "..getPlayerName(source).." az server kharej shod ("..r..")", 255, 150, 150 )
	end
end )

-- Nickname changes
addEventHandler ( "onClientPlayerChangeNick", root, function ( o, n )
	sendClientMessage ( "* "..o.." alan dige shode "..n, 255, 150, 150 )
end )
