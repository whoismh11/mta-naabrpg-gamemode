...
jobDescriptions = { 
	...
	['detective'] = [[When you are a detective in the NaaB Server, you will still have all of the features availble to you as being a normal police officer (police panel, radio chat, arrests),  other than when you are a detective you will be called on to crime cases when a fellow police officer is murdered. When you arive at the crime scene, you just have to look around for clues of the killer. You will also have the ability to spawn faster vehicles]],
...
local JobWindow = guiCreateWindow( ( sx / 2 - (rSX*500) / 2 ), (sy-(rSY*230))-rSY*15, rSX*500, rSY*230, "NaaB Bax Job System", false)
