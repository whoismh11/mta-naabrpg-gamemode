...
function createSellWindow ( ) 
	...
	sell.window = guiCreateWindow(sx*892, sy*367, sx*378, sy*391, "Foroshe vasileye naghlie", false)
	...
	sell.lbl1 = guiCreateLabel(sx*14, sy*173, sx*81, sy*18, "Gheymat:", false, sell.window)
	sell.price = guiCreateEdit(sx*95, sy*172, sx*273, sy*19, "", false, sell.window)
	sell.lbl2 = guiCreateLabel(sx*14, sy*209, sx*317, sy*18, "Tozihat (hade aksar 2000 character):", false, sell.window)
	sell.desc = guiCreateMemo(sx*15, sy*229, sx*353, sy*112, "", false, sell.window)
	sell.sell = guiCreateButton(sx*15, sy*351, sx*136, sy*27, "Forosh", false, sell.window)
	sell.close = guiCreateButton(sx*232, sy*351, sx*136, sy*27, "laghv", false, sell.window)
