...
local confirm = {}
confirm.window = guiCreateWindow( (sx_/2-(sx*324)/2), (sy_/2-(sy*143)/2), sx*324, sy*143, "Taiid", false)
...
confirm.yes = guiCreateButton(sx*10, sy*100, sx*108, sy*25, "Taiid", false, confirm.window)
confirm.no = guiCreateButton(sx*128, sy*100, sx*108, sy*25, "Enkar", false, confirm.window)
