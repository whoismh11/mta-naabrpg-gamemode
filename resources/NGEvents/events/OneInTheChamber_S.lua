...
function StartOneInTheChamber ( ) 
	for i, v in pairs ( EventCore.GetPlayersInEvent ( ) ) do
		giveWeapon ( v, 22, 2, true )
		exports.NGMessages:sendClientMessage ( "Mohemate khod ra aghelane estefade konid! Ba koshtane har nafar 1 golole daryaft khahid kard.", v, 255, 255, 255 )
	end
