...
addEventHandler( "modShop_playerLeaveModShop", getRootElement( ),
    function( vehicle, itemsCost, upgrades, colors, paintjob, shopName )
        ...
        if pMoney >= itemsCost then
            ...
            outputChatBox( "#FF0000Boodjeye nakafi! #00FF00Jibe shoma $"..tostring( getPlayerMoney( source ) )..".#FFFFFF ro neshan midahad, Chand mored ra hazf konid.", source, 0,0,0,true)
        end
    end
)
