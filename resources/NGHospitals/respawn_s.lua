...
addEventHandler ( "NGHospitals:triggerPlayerSpawn", root, function ( d )
	...
	setTimer ( function ( source )
		...
		outputChatBox ( "Spawn protection faal ast ta 3...", source, 0, 255, 255 )
		setTimer ( function ( source )
			if ( not isElement ( source ) ) then return end
			outputChatBox ( "Spawn protection faal ast ta 2...", source, 0, 255, 255 )
			setTimer ( function ( source )
				if ( not isElement ( source ) ) then return end
				outputChatBox ( "Spawn protection faal ast ta 1...", source, 0, 255, 255 )
				setTimer ( function ( source )
					if ( not isElement ( source ) ) then return end
					outputChatBox ( "Spawn protection tamoom shod! Az in be bad aasib pazir hastid.", source, 255, 0, 0 )
