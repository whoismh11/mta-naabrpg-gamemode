...
function dxDrawRemainingJailTime ( )
	dxDrawText ( tostring ( remainingTime ).. " saniye", 0, 0, (sx/1.1)+2, (sy/1.1)+2, tocolor ( 0, 0, 0, 255 ), 2.5, 'default-bold', 'right', 'bottom' )
	dxDrawText ( tostring ( remainingTime ).. " saniye", 0, 0, sx/1.1, sy/1.1, tocolor ( 255, 255, 0, 255 ), 2.5, 'default-bold', 'right', 'bottom' )
